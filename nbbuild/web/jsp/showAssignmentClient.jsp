...
<script>
	...
	function deleteData(){
		...
		document.forms[0].action="deleteAssignment?sno="+selectedId;
...
<body background="img/blue.jpg" style="background-size:cover;">
	...
	<form method="post" action="deleteAssignment" role="form" modelAttribute="DeleteMessageBean" >
