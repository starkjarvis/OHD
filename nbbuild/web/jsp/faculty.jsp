...
<body background="img/tractor.jpg" style="background-size:cover;">
	<center><h3 style="color:GREEN;">${AddAssignmentY }</h3>
	<h3 style="color:RED;">${AddAssignmentN }</h3></center>
	<center><h3 style="color: RED;">${deleteMessageN}</h3></center>
	<center><h3 style="color: GREEN;">${deleteMessageY}</h3></center>
	<center><h3 style="color: RED;">${UpdateAssignmentN}</h3></center>
	<center><h3 style="color: GREEN;">${UpdateAssignmentY}</h3></center>
