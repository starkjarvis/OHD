...
<body background="img/blue.jpg" style="background-size:cover;">
		...
		<div class="container">
            <form method="post" action="createAccountAdmin" modelAttribute="SignUpBean" class="form-horizontal" role="form" id="SignUp" onsubmit="if(document.getElementById('agree').checked) { return true; } else { alert('Please indicate that you have read and agree to the Terms and Conditions and Privacy Policy'); return false; }">
